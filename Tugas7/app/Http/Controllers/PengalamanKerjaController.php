...
class PengalamanKerjaController extends Controller
{
    ...
    {
      $pengalaman_kerja = DB::table('pengalaman_kerjas')->get();
    ...
    {
      DB::table('pengalaman_kerjas')->insert([
        'nama' => $request->nama,
    ...
    {
      $pengalaman_kerja = DB::table('pengalaman_kerjas')->where('id',$id)->first();
    ...
    {
      DB::table('pengalaman_kerjas')->where('id',$request->id)->update([
        'nama' => $request->nama,
        'jabatan' => $request->jabatan,
        'tahun_masuk' => $request->tahun_masuk,
        'tahun_keluar' => $request->tahun_keluar
    ...
    {
      DB::table('pengalaman_kerjas')->where('id',$id)->delete();
      return redirect()->route('pengalaman_kerja.index')
